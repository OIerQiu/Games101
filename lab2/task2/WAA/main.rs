        ...
        for x in 0..width {
            for y in 0..height {
                ...
                for i in 0..4 {
                    ...
                    k += 1.0;
                    f[(y*height+x) as usize].x += frame_buffer[(yy*height+xx) as usize].x;
                    f[(y*height+x) as usize].y += frame_buffer[(yy*height+xx) as usize].y;
                    f[(y*height+x) as usize].z += frame_buffer[(yy*height+xx) as usize].z;
                }
